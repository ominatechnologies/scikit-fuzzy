...
project = 'scikit-fuzzy'
copyright = '2014, the scikit-image team'
...
latex_documents = [
    ('index', 'scikit-fuzzy.tex', 'The scikit-fuzzy Documentation',
     'The scikit-image team', 'manual'),
]
...
man_pages = [
    ('index', 'scikit-fuzzy', 'scikit-fuzzy Documentation',
     ['the scikit-fuzzy team'], 1)
]
...
texinfo_documents = [
  ('index', 'scikit-fuzzy', 'scikit-fuzzy Documentation',
   'the scikit-fuzzy team', 'scikit-fuzzy', 'One line description of project.',
   'Miscellaneous'),
]
